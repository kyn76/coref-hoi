...
def kbest_logging(config_name, gpu_id, saved_suffix, boundaries, k):
    ...
    runner.csv_logging(model, examples_test, stored_info, 0, logging="kbest", gold_boundaries=gold_boundaries, k=k)
...
if __name__ == '__main__':
    ...
    kbest_logging(config_name, gpu_id, saved_suffix, boundaries, k)
